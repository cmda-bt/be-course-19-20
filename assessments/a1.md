...
_This is an individual, so tests will be conducted between one teacher and one student._
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">Data is changed (find and update) in the database through the web app; users have different states trough sessions</td>
